...
tickets = '5191198015:AAHHGe21yZhvzsV-SpnGPzvd7VQLu6L3KKs' # TOKEN Бота воркера
bot = telebot.TeleBot('5161383331:AAF8SXIQYi6E30Q1ExvM13SFFUiqS4BR1p0') # TOKEN Бота казино

admin = 1301156986 # ID Админа
support_id = 5092521925 # ID Саппорта
channel_id = -1001529167394 # ID Канала с вылатами
support = '@dskbv' # Username Сапорта

phone = '79111910757' # Номер киви без +
token = '184751914f9eac8b297ad2e73dce16e0' # API TOKEN QIWI
